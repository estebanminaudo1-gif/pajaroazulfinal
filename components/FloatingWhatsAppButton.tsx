...
export default function FloatingWhatsAppButton({
  ...
  return (
    <motion.a
      ...
      className="fixed right-6 bottom-6 z-50 flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] text-white px-4 py-3 md:px-5 md:py-3.5 rounded-full shadow-2xl focus:outline-none focus:ring-4 focus:ring-green-400/50 transition-all duration-300 group"
